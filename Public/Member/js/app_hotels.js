...
var app_hotels_obj={
	config_init:function(){
		frame_obj.file_upload($('#ImgPathFileUpload'), $('form input[name=ImgPath]'), $('#ImgPathDetail'));
		$('#ImgPathDetail').html(frame_obj.upload_img_detail($('form input[name=ImgPath]').val()));
