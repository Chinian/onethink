...
<html>
	...
	<ul>
		...
		<li <?php if((ACTION_NAME) == "owner"): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('Car/owner');?>">车主关怀</a></li>
				...
				<script type="text/javascript">$(document).ready(app_car_obj.news_list_init);</script>
				<div id="<?php echo (ACTION_NAME); ?>" class="r_con_wrap">
					
<div id="news" class="r_con_wrap">
	<div class="control_btn">
		<a href="<?php echo U('Car/news',array('id' => '0'));?>" class="btn_ok btn_ok_w_120">添加文章</a>
	</div>
		...
		<tbody> 
			<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
				...
				<td nowrap="nowrap" class="last">
					<a href="<?php echo U('Car/news', array('id' => $v['id']));?>"><img src="/test/onethink/Public/Member/images/mod.gif" align="absmiddle" alt="修改" /></a>
					<a class="news-del" data-url="<?php echo U('Car/delNews');?>" data-id="<?php echo ($v["id"]); ?>"><img src="/test/onethink/Public/Member/images/del.gif" align="absmiddle" alt="删除" /></a>
				</td>
