...
<script type="text/javascript">
	...
	<script type='text/javascript'>$(document).ready(app_car_obj.products_init);</script>

				<div id="<?php echo (ACTION_NAME); ?>" class="r_con_wrap">
					
<form id="products_form" class="r_con_form" method="post" url="<?php echo U('Car/editProduct');?>">
	<div class="rows">
		<label>产品名称</label>
		<span class="input">
	...
	<div class="rows">
		<label>排序优先级</label>
		<span class="input">
			<input type="text" name="MyOrder" value="<?php echo ((isset($product["order"]) && ($product["order"] !== ""))?($product["order"]):"0"); ?>"  class="form_input" size="35" maxlength="5" notnull />
			<font class="fc_red">*</font>
		</span>
		<div class="clear"></div>
	</div>
