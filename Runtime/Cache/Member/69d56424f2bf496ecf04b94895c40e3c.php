...
<div id="news" class="r_con_wrap">
	<form id="about_form" class="r_con_form" method="post" url="<?php echo U('Car/owner');?>">
        <div class="rows">
            <label>车主关怀</label>
            <span class="input">
		    <textarea class="ckeditor" name="Contents"><?php echo ($owner); ?></textarea>
            </span>
            <div class="clear"></div>
        </div>
        <div class="rows">
        ...
        <input type="hidden" name="do_action" value="app_car.owner" />
    </form>
</div>
