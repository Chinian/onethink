...
page:["33d3974ab3","app_car","index"],
     ...
     url_pre_module:'/test/onethink/wechat.php?s=/Wechat/Car/list/',
     member_id:'16',
...
<body>
	...
	<div id="warpper">
		...
		<div id="headerbox" class="cate_frmae">
			<div class="nav-div">
				<?php if(is_array($carcate)): $i = 0; $__LIST__ = $carcate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Car/list', array('cid' => $v['id']));?>"><?php echo ($v["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
		</div>
		<div class="line2"></div>
...
<div class="banner"><img src="<?php echo ($config["cate_img_path"]); ?>" /></div>
<nav>
<div class="nav_list"><a href="detail/644/">11</a></div>
<div class="nav_list"><a href="detail/643/">请求</a></div>
</nav>
