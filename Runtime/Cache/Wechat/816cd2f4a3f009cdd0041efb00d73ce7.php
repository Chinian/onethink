		...
		<div id="businesscard_skin_5">
			...
			<div class="box3">
				<div class="box3_item1">
					<?php if($data['isweb'] == 1): ?><div class="f_icon"><a href="../web/"><span class="bg1" style="width:34%;"></span></a></div><?php endif; ?>
					<div class="f_icon"><a href="http://api.map.baidu.com/marker?location=<?php echo ($data["loc"]); ?>&title=<?php echo (urlencode($data["company"])); ?>&name=<?php echo (urlencode($data["company"])); ?>&content=<?php echo (urlencode($data["add"])); ?>&output=html"><span class="bg2"></span></a></div>
