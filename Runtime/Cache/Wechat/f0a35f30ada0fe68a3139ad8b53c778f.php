...
<nav>
<?php if(is_array($tools)): $i = 0; $__LIST__ = $tools;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><div class="nav_list"><a href="<?php echo ($t["url"]); ?>"><?php echo ($t["name"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
