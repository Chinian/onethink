				...
				<div id="businesscard_skin_4">
					...
					<div class="box1">
						<div class="box1_item1">
							...
							<div class="footer">
								<div class="f_icon"><a href="../web/"><img src="/test/onethink/Public/Businesscard/images/businesscard/skin_4/f1.png" /></a></div>                <div class="f_icon"><a href="http://api.map.baidu.com/marker?location=<?php echo ($data["loc"]); ?>&title=<?php echo (urlencode($data["company"])); ?>&name=<?php echo (urlencode($data["company"])); ?>&content=<?php echo (urlencode($data["add"])); ?>&output=html'"><img src="/test/onethink/Public/Businesscard/images/businesscard/skin_4/f2.png" /></a></div>
