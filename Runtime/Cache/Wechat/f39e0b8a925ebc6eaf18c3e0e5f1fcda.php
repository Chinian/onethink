...
<nav>
<?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="nav_list"><a href="<?php echo U('Car/product', array('detail' => $v['id']));?>/"><?php echo ($v["name"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
</nav>
