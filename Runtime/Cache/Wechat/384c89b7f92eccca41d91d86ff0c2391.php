		...
		<div id="businesscard_skin_3">
			...
			<div class="box1">
				...
				<div class="box1_item2">
					...
					<div class="icon"><a class="c2" href="../web/"></a></div>            <div class="icon"><a class="c3" href="http://api.map.baidu.com/marker?location=<?php echo ($data["loc"]); ?>&title=<?php echo (urlencode($data["company"])); ?>&name=<?php echo (urlencode($data["company"])); ?>&content=<?php echo (urlencode($data["add"])); ?>&output=html"></a></div>
