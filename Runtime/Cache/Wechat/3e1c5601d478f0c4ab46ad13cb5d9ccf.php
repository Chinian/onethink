...
<nav>
<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a style="text-decoration:none;" href="<?php echo U('Car/news', array('nid' => $v['id']));?>">
	<div class="news_list">
		<div class="news_img"><img src="<?php echo ($v["imgpath"]); ?>" height="100%" /></div>
		<div class="news_info">
			<div class="news_title"><?php echo ($v["title"]); ?></div>
			<div class="news_dec"><?php echo ($v["brief_des"]); ?></div>
		</div>
