...
<link href="/test/onethink/Public/static/bootstrap/css/bootstrap.css" rel="stylesheet">
<link href="/test/onethink/Public/static/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
<link href="/test/onethink/Public/static/bootstrap/css/docs.css" rel="stylesheet">
<link href="/test/onethink/Public/static/bootstrap/css/onethink.css" rel="stylesheet">

<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
<script src="/test/onethink/Public/static/bootstrap/js/html5shiv.js"></script>
<![endif]-->

<!--[if lt IE 9]>
<script type="text/javascript" src="/test/onethink/Public/static/jquery-1.10.2.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
<script type="text/javascript" src="/test/onethink/Public/static/jquery-2.0.3.min.js"></script>
<script type="text/javascript" src="/test/onethink/Public/static/bootstrap/js/bootstrap.min.js"></script>
<!--<![endif]-->
...
(function(){
	var ThinkPHP = window.Think = {
		"ROOT"   : "/test/onethink", //当前网站地址
		"APP"    : "/test/onethink/index.php?s=", //当前项目地址
		"PUBLIC" : "/test/onethink/Public", //项目公共目录地址
